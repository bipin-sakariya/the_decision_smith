  ...
  render() {
    return (
      <ScrollView style={{ padding: 5 }}>
        ...
        <Text style={{ fontWeight: 'bold' }}> Last updated: March 25, 2023 {"\n"} </Text>
        ...
        <Text>
          ...
          Application refers to The Decision Smith, the software program
          provided by the Company.{"\n"}
          {"\n"}Company (referred to as either "the Company", "We", "Us" or "Our"
          in this Agreement) refers to The Decision Smith, 1504-5250
          Lakeshore Rd. Burlington.{"\n"}
          ...
          {"\n"}•By email: thedecisionsmith@gmail.com{"\n"}
        </Text>
      </ScrollView>
    )
  }
